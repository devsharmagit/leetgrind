...
import { Code2, Sparkles, ArrowRight, Users, Trophy, BarChart3, UserPlus } from 'lucide-react';
          ...
          <div className="hidden lg:block space-y-8">
            ...
            <div>
              ...
              <p className="text-neutral-400 text-lg leading-relaxed">
                Set up your group and start competing with friends in under a minute.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Sign up with Google in one click — no passwords to remember.',
                },
                {
                  step: '2',
                  icon: Users,
                  title: 'Create a Group & Add Friends',
                  description: 'Name your group and add your friends\' LeetCode usernames.',
                },
                {
                  step: '3',
                  icon: Trophy,
                  title: 'Compete on the Leaderboard',
                  description: 'See live rankings, track daily progress, and grind together.',
                },
              ].map((item, i) => (
                <div key={i} className="flex gap-4 items-start group">
                  <div className="w-12 h-12 bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 border border-yellow-500/30 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 border border-yellow-500/20 rounded-xl p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-neutral-400 text-sm">
                  No credit card, no trial period, no catch. Just create an account and start grinding.
                </p>
              </div>
            </div>
          </div>
            ...
            <Card className="bg-gradient-to-br from-neutral-900 to-neutral-950 border-neutral-800 shadow-2xl backdrop-blur-sm">
              <CardHeader className="text-center space-y-2 pb-6">
                ...
                <CardDescription className="text-neutral-400 text-base">
                  Join the grind — it only takes a few seconds
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  {[
                    { icon: Users, text: 'Create groups with up to 200 members' },
                    { icon: Trophy, text: 'Live leaderboards & daily rankings' },
                    { icon: BarChart3, text: 'Historical analytics & progress charts' },
                  ].map((item, i) => (
